        ...
        <div class="col-md-8">
          ...
          >
            <template slot="header">
              ...
              <p class="card-category">Tree & Maps</p>
            </template>
        ...
        <div class="col-md-4">
          <chart-card :chart-data="pieChart.data" chart-type="Pie">
            <template slot="header">
              ...
              <p class="card-category">Last Upload Performance</p>
            </template>
            <template slot="footer">
              <div class="legend">
                <i class="fa fa-circle text-info"></i> With images
                <i class="fa fa-circle text-danger"></i> With Categories
              </div>
              <hr />
              <div class="stats">
